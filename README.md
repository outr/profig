...
```
libraryDependencies += "com.outr" %% "profig" % "3.0.1"   // Scala
libraryDependencies += "com.outr" %%% "profig" % "3.0.1"  // Scala.js / Cross-Build
```

On the JVM, if you wish to get access to all file formats and extension features of Profig, you can utilize `profig-all`:

```
libraryDependencies += "com.outr" %% "profig-all" % "3.0.1"
```
